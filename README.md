...
In this game, the computer will choose a number between 1 and 100, and you as the player has to guess the coreect number with available number of chances gives to guess.
